...
| `/feasibility` | PF | semua (ajukan: pm ke atas) | `feasibility_cases`, `skills`, `profile_skills`, `allocations` | **dibangun** |
| `/budget` | BC | manager ke atas — **`talent` tidak** | `budget_lines`, `budget_summary`, `budget_entries` | **dibangun** |
