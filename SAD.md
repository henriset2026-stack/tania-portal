...
| **Terkait** | `PRD.md` (apa & mengapa) · `SRS.md` (spesifikasi formal & kriteria uji) · `AGENTS.md` (aturan operasional untuk agent) · `docs/TANIA_Avatar_Addendum.md` |
...
- `UIUX.md` — spesifikasi UI/UX: peta halaman, layar kunci, pola interaksi, aksesibilitas
