...
**Read before changing anything:** `PRD.md` (what and why) · `SAD.md` (how it is built) · `SRD.md` (formal, testable behaviour — the SF-x rules and acceptance criteria) · `supabase/migrations/` (the actual truth).
